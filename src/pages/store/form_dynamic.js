        ...
        templates: {
            tplUser: function (data) {
                ...
                data.forEach(function (item, index) {
                    ...
                    <div class="span1">
                        <div class="bui-value"><input id="{{$index}}" type="text" name="fname" placeholder="请输入" b-model="page.users.$index.name" b-target="ul"></div>
                    </div>
                </li>
                <li class="bui-btn bui-box clearactive">
                    <label class="bui-label">身份证</label>
                    <div class="span1">
                        <div class="bui-value"><input type="text" name="fname" placeholder="请输入" b-model="page.users.$index.id" b-target="ul"></div>
                    </div>
                </li>`
                })
                html += `</ul>`
